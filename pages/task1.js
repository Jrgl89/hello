...
export default function nameCard() {
  ...
  return (
    <div className=" bg-black h-[1500px] w-screen relative">
      ...
      <Image src="/fb.webp" width={50} height={50} className="rounded-xl ml-10"/>
      ...
      <div className="flex">
        <Image src="/mark.png" width={700} height={600} className="rounded-xl absolute left-[150px] top-[250px]"/>
